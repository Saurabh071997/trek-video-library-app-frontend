    ...
    <div className="footer">
      <div className="footer-content">
        ...
        <div className="footer-content-txt">
          Sign up now and be the first to access the exclusive content. Feel the
          rush, feel the adrenaline pumping, watch our amazing videos of
          daredevils.
        </div>
      </div>
      ...
      <div className="footer-content">
        <div className="footer-content-txt">
          ...
          Arepo . Arepo's business concept is to offer quality content at the
          best.
        </div>
        <div className="footer-app-name">Trek</div>
